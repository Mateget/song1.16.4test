...
public class ExampleMod{
	...
	public static final String MODNAME = "Test Song";
    ...
    private static final SoundEvent createSoundEvent(ResourceLocation location) {
		return new SoundEvent(location).setRegistryName(location);
	}
    
    public static final SoundEvent DIGGY_SONG = createSoundEvent(new ResourceLocation(ExampleMod.MODID, "diggy"));
